                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="border-dashed bg-white border-lightgray border rounded-[30px] flex py-2 px-4 max-sm:px-[10px] max-sm:gap-3 gap-4 mb-5 max-w-[768px] mx-auto">
                            {selectedImages.map((image, index) => (
                                <img
                                    key={index}
                                    className="rounded-[20px] max-w-[96px]"
                                    src={image}
                        ...
                        <div className="flex p-4 rounded-[30px] border-lightgray border bg-white mb-5 relative">
                            <input
                                className="w-full outline-none text-sm font-bold placeholder-gray"
                                type="text"
                                required
                                name="category"
                            ...
                            />
                            <img
                                className="rounded-[20px] max-w-[96px] cursor-pointer"
                                ...
                                <div className="absolute top-full right-0 mt-2 w-48 bg-white border border-lightgray rounded-lg shadow-md">
                                    <ul className="list-none p-2">
                                        ...
                                        <li
                                            className="p-2 cursor-pointer"
                                            onClick={() => {
                                                setFormData({ ...formData, category: "Travel" });
                                                setShowDropdown(false); 
                                            }}
                                        >
                                            Travel
                                        ...
                                        <li
                                            className="p-2 cursor-pointer"
                                            onClick={() => {
                                                setFormData({ ...formData, category: "Cloths" });
                                                setShowDropdown(false); 
                                            }}
                                        >
                                            Cloths
                        ...
                        <div className="flex gap-5 mb-5">
                            <input
                                className="py-[17.5px] pl-4 max-sm:py-3 rounded-[30px] placeholder-gray border-lightgray border outline-none text-sm font-bold w-[50%]"
                                type="text"
                                required
                                name="title"
                                placeholder="Titel"
                        ...
                        <div className="flex gap-5 pb-5">
                            ...
                            />
                            <input
                                className="py-[17.5px] max-sm:py-3 pl-4 rounded-[30px] placeholder-gray border-lightgray border outline-none text-sm font-bold w-[50%]"
                                type="text"
                                required
                                name="price"
                                placeholder="Preis"
                        ...
                        <textarea
                            className="w-full py-[55.5px] max-sm:pt-10 max-sm:pb-5 mb-5 leading-6 text-sm font-bold resize-none outline-none pl-4 rounded-[30px] border-lightgray border text-gray placeholder-gray"
                        ...
                        <button
                            type="submit"
                            className="py-4 px-[115px] max-sm:px-0 max-sm:w-full text-center rounded-[30px] mx-auto bg-custom-gradient sm:flex font-bold text-white"
                        >
                            Event einsenden
                        </button>
                    </form>
